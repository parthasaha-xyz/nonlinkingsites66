                ...
                <div data-image-container="vcard_avatar" class="<?= !empty($data->link->settings->vcard_avatar) ? null : 'd-none' ?>">
                    <div class="row">
                        <div class="my-2 col-6 col-xl-4">
                            <img src="<?= $data->link->settings->vcard_avatar ? \Altum\Uploads::get_full_url('avatars') . $data->link->settings->vcard_avatar : null ?>" class="img-fluid rounded <?= !empty($data->link->settings->vcard_avatar) ? null : 'd-none' ?>" loading="lazy" />
                        </div>
                    </div>
                    ...
                    <?php foreach($data->link->settings->vcard_phone_numbers ?? [] as $key => $phone_number): ?>
                        <div class="mb-4">
                            <div class="form-group">
                                ...
                                <input id="<?= 'vcard_phone_number_label_' . $key . '_' . $data->link->link_id ?>" type="text" name="vcard_phone_number_label[<?= $key ?>]" class="form-control" value="<?= $phone_number->label ?>" maxlength="<?= $data->link_types['vcard']['fields']['phone_number_label']['max_length'] ?>" />
                            </div>

                            <div class="form-group">
                                <label for="<?= 'vcard_phone_number_value_' . $key . '_' . $data->link->link_id ?>"><?= l('create_biolink_vcard_modal.vcard_phone_number_value') ?></label>
                                <input id="<?= 'vcard_phone_number_value_' . $key . '_' . $data->link->link_id ?>" type="text" name="vcard_phone_number_value[<?= $key ?>]" value="<?= $phone_number->value ?>" class="form-control" maxlength="<?= $data->link_types['vcard']['fields']['phone_number_value']['max_length'] ?>" required="required" />
                            </div>
